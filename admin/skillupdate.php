...
if(!empty($_POST["update"]) && $_POST["update"]) {
	$message = $user->editskill();
}
$userDetail = $user->updateskill();
            ...
            <div class="row">
              ...
              <?php if($message != '') { ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <label>range</label>
                      <input class="form-control" type="text" name="count" placeholder="please input" value="<?php echo $userDetail['count'];?>">
                    </div>
